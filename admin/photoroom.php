...
if ($method == "POST") {
    ...
    if (isset($_POST['uyeekle'])) {
        ...
        if ($ekle->execute(array(1, $name, $upload))) {
            ...
            echo ("<script>window.location.href = 'photoroom.php?uyeekle'</script>");
        }
    }
    if (isset($_POST['hizmetguncelle'])) {
        ...
        if ($update->execute(array($ad, $aciklama, $id))) {
            ...
            echo ("<script>window.location.href = 'photoroom.php'</script>");
        }
    }
    ...
    if (isset($_POST['submit'])) {
        ...
        $updatetr = $db->prepare("UPDATE photoroom set hero_title=?,hero_subtitle=?,has_mask_title=?,has_mask_subtitle=?,has_mask_subtitle_2=?,has_mask_services=?,next_hero_title=?,next_hero_subtitle=? where Dil=?");
        $updatetr = $updatetr->execute(array($hero_title_tr, $hero_subtitle_tr, $has_mask_title_tr, $has_mask_subtitle_tr, $has_mask_subtitle_2_tr, $has_mask_services_tr, $next_hero_title_tr, $next_hero_subtitle_tr, 1));

        $updateen = $db->prepare("UPDATE photoroom set hero_title=?,hero_subtitle=?,has_mask_title=?,has_mask_subtitle=?,has_mask_subtitle_2=?,has_mask_services=?,next_hero_title=?,next_hero_subtitle=? where Dil=?");
        $updateen = $updateen->execute(array($hero_title_en, $hero_subtitle_en, $has_mask_title_en, $has_mask_subtitle_en, $has_mask_subtitle_2_en, $has_mask_services_en, $next_hero_title_en, $next_hero_subtitle_en, 2));

        $updatede = $db->prepare("UPDATE photoroom set hero_title=?,hero_subtitle=?,has_mask_title=?,has_mask_subtitle=?,has_mask_subtitle_2=?,has_mask_services=?,next_hero_title=?,next_hero_subtitle=? where Dil=?");
        $updatede = $updatede->execute(array($hero_title_de, $hero_subtitle_de, $has_mask_title_de, $has_mask_subtitle_de, $has_mask_subtitle_2_de, $has_mask_services_de, $next_hero_title_de, $next_hero_subtitle_de, 3));
        ...
        if ($update) {
            header("location:photoroom.php?basarili");
        } else {
            header("location:photoroom.php?hatali");
        }
    }
}
                        ...
                        if ($sayfakontrol == "") { ?>
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title">Photoroom Ayarları</h5>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="col-xs-12">
                                        <form action="" method="POST" enctype="">
                                            ...
                                            <?php
                                            $bridetr = $db->query("SELECT * FROM photoroom where dil=1");
                                            $bridetrcount = $bridetr->rowCount();
                                            if ($bridetrcount) {
                                                $bridetr = $bridetr->fetch(PDO::FETCH_ASSOC);
                                            }
                                            $brideen = $db->query("SELECT * FROM photoroom where dil=2");
                                            $brideencount = $brideen->rowCount();
                                            if ($brideencount) {
                                                $brideen = $brideen->fetch(PDO::FETCH_ASSOC);
                                            }

                                            $bridede = $db->query("SELECT * FROM photoroom where dil=3");
                                            ...
                                            <div class="row form-group">
                                                <div class="col">
                                                    ...
                                                    <div class="row mx-4 justify-content-center">
                                                        ...
                                                        <textarea rows="5" class="form-control" id="left" type="text" name="has_mask_subtitle_tr"><?php echo $bridetr['has_mask_subtitle']; ?></textarea>
                                                    </div>
                                                    <div class="row mx-4 justify-content-center">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="row mx-4 justify-content-center">
                                                        <label for="left">İçerik 2</label>
                                                        <textarea rows="5" class="form-control" id="left" type="text" name="has_mask_subtitle_en"><?php echo $brideen['has_mask_subtitle']; ?></textarea>
                                                    </div>
                                                    <div class="row mx-4 justify-content-center">
                                                        <label for="left">İçerik 3</label>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="row mx-4 justify-content-center">
                                                        <label for="left">İçerik 2</label>
                                                        <textarea rows="5" class="form-control" id="left" type="text" name="has_mask_subtitle_de"><?php echo $bridede['has_mask_subtitle']; ?></textarea>
                                                    </div>
                                                    <div class="row mx-4 justify-content-center">
                                                        <label for="left">İçerik 3</label>
                                                    ...
                                                    <div class="row mx-4 justify-content-center">
                                                        <label for="left">Hizmetlerimiz Alanı</label>
                                                        <input class="form-control" id="left" type="text" name="has_mask_services_de" value="<?php echo $bridedede['has_mask_services']; ?>">
                                                    </div>
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    ...
                                                    <a href="photoroom.php?hizmetekle">
                                                ...
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <table class="table table-hover table-responsive-sm">
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                $gettr = $db->prepare("SELECT * FROM services where ServicesID=2");
                                                                $gettr->execute();
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><span><a href="photoroom.php?hizmetduzenle=<?php echo $rows['ID']; ?>" class="mr-4" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil color-muted"></i> </a><a href="photoroom.php?hizmetsil=<?php echo $rows['ID']; ?>" data-toggle="tooltip" data-placement="top" title="Close"><i class="fa fa-close color-danger"></i></a></span></td>
                                                                    </tr>
                                                                <?php } ?>
