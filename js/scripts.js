		...
		if (!$("body").hasClass("load-no-ajax")) {
			$('.next-ajax-link-project').on('click', function() {					
				...
				if ($(this).parents('#project-nav').hasClass("change-header")) {
					$("body").append('<div class="temporary-hero" style="visibility:hidden;"><div class="outer"><div class="inner"></div></div></div>');
				} else {
					$("body").append('<div class="temporary-hero light-content" style="visibility:hidden;"><div class="outer"><div class="inner"></div></div></div>');
				}
